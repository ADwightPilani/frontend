...
class ManageCompStockMap extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('https://advaittest.herokuapp.com/getAllMaps',myInit1)
    ...
    render() {
        ...
        try{for (const [index, value] of elements1.entries()) {
            ...
            items.push(
                <Card >
                    <Card.Body>
                        <Card.Text>
                            Company Name: {value[0]} &emsp;&emsp;
                            Company Code: {value[1]} &emsp;&emsp;
                            Stock Exchange: {value[2]} &emsp;&emsp;
                        </Card.Text>
        ...
        return (<>
            <div class="a">
                <h1 >List of Company Stock Exchange Mappings</h1>
            </div>
            <div>
                {items}
            </div>
...
export default ManageCompStockMap;